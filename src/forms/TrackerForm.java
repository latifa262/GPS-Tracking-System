...
public class TrackerForm extends javax.swing.JInternalFrame {
    ...
    private static TrackerForm instane;
    public static TrackerForm getInstane() {
		if(instane == null)
                	instane = new TrackerForm();
		return instane;
	}
    /**
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (ts.create(new GPSTracker(simNumber))) {
