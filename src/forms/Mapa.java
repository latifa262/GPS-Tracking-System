...
public class Mapa extends MapView implements ActionListener{
 ...
 */
	...
	public Mapa(String pString) {
			...
			public void onMapReady(MapStatus status) {
				...
				if (status == MapStatus.MAP_STATUS_OK) {
					...
					map.setOptions(mapOptions);
                                        System.out.println("d5uuul");
					map.setCenter(new LatLng(31.643775300218238, -8.040015888354864));
                                        System.out.println("5ruj");
                                   //    map.setCenter(new LatLng(32.643775300218238, -10.040015888354864));
					map.setZoom(10);
		...
		frame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
                ...
                JLabel lab1=new JLabel("Latitude :");
                JLabel lab2=new JLabel("Longitude :");
                JTextField latitude=new JTextField("",20);
                //latitude.setBounds(0, 0, 2000, 300);
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
        System.out.println("raak wrkti 3la chercher"+",ha  attitude");//To change body of generated methods, choose Tools | Templates.
    }
